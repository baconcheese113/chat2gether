...
describe('in_call_spec', function() {
  ...
  it('Uses countdown widget', function() {
    ...
    cy.dataCy('countdownText')
      .contains(/go/i, { timeout: 20000 })
      .should('exist');
  ...
  it('Uses video player widget', function() {
    ...
    cy.dataCy('navPlayerButton')
      ...
      .click()
      .wait(1000);
    cy.dataCy('playerSyncButton')
      .should('contain.text', 'Accept Sync')
      .click()
